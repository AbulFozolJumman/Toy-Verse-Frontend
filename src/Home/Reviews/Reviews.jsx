...
const Reviews = () => {
    return (
        <div className="my-12">
            <h2 className="text-4xl container mx-auto font-bold p-2 border-s-4 border-pink-600 mb-5">Customer Reviews</h2>
            <Marquee>
                <div className="bg-gray-100 p-6 rounded-md shadow-pink-500 shadow-md mb-4 w-[400px] h-[200px] mx-5">
